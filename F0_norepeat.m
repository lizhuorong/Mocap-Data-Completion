...
% final
function [mae_PLOS1,mae_xyz,rate,A_GAP_pad] = compute_F0(A,B) 
...
% A_GAP =  [A(1:300,:);temppp;A(401:end,:)];% Maju 300-400
...
if ~isempty(repeatID)
    ...
    A_GAP(:,25:36),A_GAP(:,34:36),A_GAP(:,37:45),A_GAP(:,43:45)];% ..x57
end
end
