...
function [mae_PLOS1,mae_xyz,rate,A_GAP_pad] = compute_T0(A,B)
B = B';
M = B*B';
[u,d,v]=svd(M);
[n,m] = size(B(:,1:100));%n:45,m:100
% s = 0;
% while s<15
...
% A_GAP =  [A(1:200,:);temppp;A(301:end,:)];
% A_GAP =  [A(1:300,:);temppp;A(401:end,:)];
A_GAP =  [A(1:450,:);temppp;A(551:end,:)];%man_cut_7
% A_GAP = [];
